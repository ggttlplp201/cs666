...
def hard_filter_reasons(
    ...
    hard_max = cfg_sel.get("total_supply_hard_exclude_above", 50000)
    lo_broad, hi_broad = cfg_sel.get("total_supply_broad", [10000, 30000])
    lo_sweet, _ = cfg_sel.get("total_supply_sweet_spot", [2000, 10000])
    if supply > hard_max:
